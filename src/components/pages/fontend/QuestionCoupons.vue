<template>
  <div>
    ...
    <div class="container text-center mt-4 img-thumbnail rounded pt-3 pb-3 position-relative knowledge">
      ...
      <h2 class="text-light mt-5"><i class="fas fa-angle-double-down"></i> 快來挑戰看看吧 <i class="fas fa-angle-double-down"></i></h2>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content border-0">
          <div class="modal-header bg-qustion text-white">
            ...
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" @click="restAnswer">
          ...
          <div class="modal-body text-center pt-5 pb-5 position-relative">
            ...
            <img v-if="result > 2" src="../../../assets/images/catGood.jpeg" class="position-absolute answerCat">
...
export default {
  ...
  methods:{
    checkAnswer(){
      const vm = this;
      vm.answer1 === '2' ? vm.check.push(true) : vm.check.push(false);
      vm.answer2 === '1' ? vm.check.push(true) : vm.check.push(false);
      vm.answer3 === '3' ? vm.check.push(true) : vm.check.push(false);
      vm.answer4 === '1' ? vm.check.push(true) : vm.check.push(false);
      vm.answer5 === '1' ? vm.check.push(true) : vm.check.push(false);
      vm.answer6 === '1' ? vm.check.push(true) : vm.check.push(false);
      let result = vm.check.reduce((prev, current) => {
        if(current){
          prev.push(current);
        }
        return prev;
