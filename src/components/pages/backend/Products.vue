<template>
  <div>
    ...
    <div class="text-right mt-4">
      <button class="btn btn-info" data-toggle="modal" @click="openModel(true)">建立新的產品</button>
    </div>
    ...
    <div class="modal fade" id="delProductModal" tabindex="-1" role="dialog"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content border-0">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-secondary" @click="deleteProduct(false)">取消</button>
            <button type="button" class="btn btn-danger" @click="deleteProduct(true)"
              >確認刪除</button>
          </div>
        </div>
      </div>
