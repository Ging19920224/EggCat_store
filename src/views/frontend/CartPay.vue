<template>
  <div>
    <Progress :step="step" class="mt-72 pt-2 mb-3"></Progress>
    <div class="container text-center mt-3 mb-5 pt-3">
        ...
        <table class="table table-striped col-md-6 col-12 mr-5 border rounded ">
          ...
          <tbody>
            <tr v-for="(item, index) in order.products" :key="index">
              ...
              <td>{{ order.products[index].product.num }}/
                {{ order.products[index].product.unit }}</td>
      ...
      @click="payOrder"
      class="btn btn-danger">確認付款 <i class="fas fa-caret-right"></i></button>
      <router-link to="/CustomerProduct/0"
      v-else class="btn btn-primary">繼續購物 <i class="fas fa-shopping-cart"></i></router-link>
    </div>
    <div class="modal fade" id="paySuccess" tabindex="-1" role="dialog"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content border-0">
          ...
          <div class="modal-body position-relative">
              <img src="../../assets/images/cat3Q.jpg" class="answerCat">
              <span class="h6 text-color">付款成功！！非常感謝您的購買～喵</span>
              <img src="../../assets/images/cathand.png" class="ml-3 cathand">
          </div>
        </div>
      </div>
    </div>
    <div class="modal fade" id="payFailure" tabindex="-1" role="dialog"
      aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content border-0">
          ...
          <div class="modal-body position-relative">
              <img src="../../assets/images/catSorry.png" class="answerCat">
